    ...
    <React.Fragment>
      ...
      >
        ...
        >
                  ...
                  style={{
                    ...
                    background:
                      item.path === location.pathname
                        ...
                        : "none",
                    borderRadius:
                      item.path === location.pathname ? "9px 0px 0px 8px" : "initial",
                  }}
                >
                  <MenuItem
                    component={<Link to={item.path} />}
                    icon={item.path == location.pathname ? item.activeIcon : item.icon}
                  >
                    <Typography
                      sx={{
                        position: "relative",
                        ...
                        color: item.path === location.pathname ? "white" : "#607489",
                      }}
                    >
                      {item.title}
                    </Typography>
          ...
          {!collapsed && (
            <Box component={"div"} position={"absolute"} bottom={20} left={20}>
