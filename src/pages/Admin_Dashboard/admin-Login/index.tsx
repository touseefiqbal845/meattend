  ...
  const handleLogin = async () => {
    try {
      ...
      if (email && password && re.test(email) && password.length > 6) {
        ...
        const response = await AdminAuthApiService.loginApi(
          JSON.stringify(info)
        );
        ...
        if (response.status === 200) {
          ...
          navigate("/staffing/newcompanines");
        } else {
          dispatch({
            type: "loginFailed",
          ...
          <Card className={classes.card}>
              <CardHeader
                ...
                title={
                  ...
                  >
                    <Typography sx={{ fontSize: "40px", fontWeight: "600",color:"#000315", lineHeight:"50.2px" }}>
                      Sign In&nbsp;
                    </Typography>{" "}
                    to your portal
                  </Typography>
            ...
            <CardContent>
              <div>
                ...
                />
                <Error text={state.helperText} fontSize={14} fontWeight={400} />
                <Error
            ...
            <div>
              <Box
                ...
                my={2}
              >
                <Box width="40%" borderBottom="1px solid #D8DAE7" mr={2}></Box>
                <Typography variant="h6" fontSize="14px">
                  Or
                </Typography>
                <Box width="40%" borderBottom="1px solid #D8DAE7" ml={2}></Box>
              </Box>
              <Box
                display="flex"
                alignItems="center"
