...
const StaffPackagesCardComponent: React.FC<CardData> = ({
  title,
  description,
  price,
  isActive,
    ...
    <React.Fragment>
      <Grid item xs={12} sm={6} md={4} lg={4} xl={3}>
        ...
        >
          ...
          >
            <PersonAddAltIcon style={{ color: "#1877f2" }} />
          </Box>
  ...
  return (
    <Grid container spacing={2} mt={2}>
      {cardsData.map((card, index) => (
        <StaffPackagesCardComponent key={index} {...card} />
      ))}
    </Grid>
  );
};

export default StaffPackagesCard;
